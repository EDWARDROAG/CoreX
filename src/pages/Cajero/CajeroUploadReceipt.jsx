...
/*                                                                            */
/*  📄 ARCHIVO: CajeroUploadReceipt.jsx                                       */
/*  📁 UBICACIÓN: frontend/src/pages/Cajero/CajeroUploadReceipt.jsx           */
...
/*  🎯 PROPÓSITO                                                              */
/*  ------------------------------------------------------------------------  */
/*  Componente modal para la subida de comprobantes de transferencia en el   */
/*  punto de venta (POS). Permite al cajero seleccionar un archivo de        */
/*  imagen, validar su formato y tamaño, y previsualizarlo antes de          */
/*  confirmar la venta.                                                      */
/*                                                                            */
...
/*  • Recibe props para manejo de archivos                                    */
/*                                                                            */
/*  ⚠️ NOTAS IMPORTANTES                                                      */
/*  ------------------------------------------------------------------------  */
/*  • Solo se aceptan imágenes                                               */
/*  • El tamaño máximo es 5MB                                                 */
/*  • Se recomienda que el cliente envíe el comprobante por WhatsApp antes   */
/*                                                                            */
